...
class SystemModelEnums(BaseEnum):
    M = name_tuple(30, "Number of FNs")
    K = name_tuple(250, "Number of MUEs")
    K__max = name_tuple(10, "maximum number of accessible MUEs in each FN")
    N = name_tuple(100, "Number of Tasks")
    ...
    D2D_establish_threshold = name_tuple(0, "dBm D2d establishment threshold") #???
    g_u_i_m = name_tuple(0, "channel gain of uplink")  #???
    g_d_i_m = name_tuple(0, "channel gain of downlink")  #???
